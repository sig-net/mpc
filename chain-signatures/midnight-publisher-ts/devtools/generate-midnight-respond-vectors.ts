...
interface OracleFixture {
  oracle: {
    ...
    midnightIntegrationCommit: "f3c3e3906d193db903430f101bdf56aea9713dcf";
    midnightPackage: "@sig-net/midnight@0.24.0-rc.4";
    serializerPackage: "@sig-net/midnight-serde@0.24.0-rc.4";
    ethers: "6.17.0";
  };
