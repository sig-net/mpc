...
pub struct PresignatureManager {
    /// Completed unspent presignatures cache.
    /// This is contains a subset of the presignatures in presignature manager,
    ...
    /// Completed unspent presignatures store.
    pub presignature_storage: PresignatureLockNodeStorageBox,
}
