...
*The only gap in this list that needs a member to misbehave. The other eight bite
under §2's crash-recovery model, with no adversary anywhere, though 6 and 7 bite
harder with one.*
