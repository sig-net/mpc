...
export const SUPPORTED_COMPACTC_VERSIONS = ['0.29', '0.30', '0.31', '0.33'];
/**
 ...
 */
export const resolveCompactcVersion = (rawCompactcVersion = process.env.COMPACTC_VERSION) => {
    if (!rawCompactcVersion) {
        console.error(`COMPACTC_VERSION is not set (expected one of ${SUPPORTED_COMPACTC_VERSIONS.join(', ')}). ` +
...
export const toolkitPackageName = (compactcVersion) => `@midnight-ntwrk/node-toolkit-compact-${compactcVersion}`;
/**
 ...
 */
export const installCompactcResolver = (compactcVersion) => {
     ...
     */
    const toolkitResolve = (specifier) => {
    ...
    registerHooks({
        resolve(specifier, context, next) {
            ...
            if (specifier.startsWith('@midnight-ntwrk/compact-js') ||
                ...
                specifier.startsWith('@midnightntwrk/ledger-v9') ||
                specifier.startsWith('@midnightntwrk/onchain-runtime-v4')) {
                return {
...
//# sourceMappingURL=compactc-resolver.js.map